...
},{"process":"../../node_modules/process/browser.js"}],"../../node_modules/vue/dist/vue.runtime.esm.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{}],"../../node_modules/vuejs-paginate/dist/index.js":[function(require,module,exports) {
var define;
    ...
    Vue.mixin({
      ...
      methods: {
        ...
        filterQuery: function filterQuery() {
          this.estates = this.estatesFiltered; // @TODO: Filters & sorting | use params e.g. { filter: [ date: true, ... ] }
        ...
        $sweepBrightList: function $sweepBrightList() {
          var _this3 = this;

          this.isLoading = true;

          _axios.default.get('/wp-json/v1/sweepbright/list').then(function (response) {
            _this3.estatesFiltered = _this3.generateUid(response.data.data);
            _this3.estates = _this3.generateUid(response.data.data);

            _this3.setTotalPages();
...
exports.default = _default;
},{"axios":"../../node_modules/axios/index.js","jquery":"../../node_modules/jquery/dist/jquery.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js","vuejs-paginate":"../../node_modules/vuejs-paginate/dist/index.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
