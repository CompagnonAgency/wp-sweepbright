...
},{"process":"../../node_modules/process/browser.js"}],"../../node_modules/vuejs-paginate/dist/index.js":[function(require,module,exports) {
var define;
...
},{}],"wp-sweepbright-public.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  install: function install(Vue) {
    Vue.component('paginate', _vuejsPaginate.default);
    Vue.mixin({
      computed: {
        activePage: {
          get: function get() {
      ...
      data: function data() {
        return {
          ...
          request: {
            ...
            filters: {
              status: false,
              // available, sold, option, under_contract, rented
              new_home: false,
              // new, used
              negotiation: false,
              // sale, let, projects, sale_non_projects
              category: [],
              // see API docs `type`
              subcategory: [],
              // see API docs `type`
      ...
      methods: {
        $formatNumber: function $formatNumber(price, format) {
          switch (format) {
            case "DOT":
              price = price.toString().replace(/\./g, ",").toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");
              break;
        ...
        $urlQuery: function $urlQuery() {
          var negotiation = this.$urlParam()["negotiation"];
          var region = this.$urlParam()["region"];
          var lat = parseFloat(this.$urlParam()["lat"]);
          var lng = parseFloat(this.$urlParam()["lng"]);
        ...
        storeEstates: function storeEstates(params, response) {
          ...
          var event = new Event('loadedEstates');
          ...
          if (window.location.hash) {
            if (document.querySelector('[data-sweepbright-list]')) {
              (0, _jquery.default)('html, body').animate({
                scrollTop: (0, _jquery.default)('[data-sweepbright-list]').offset().top - 100
              }, 200);
              (0, _jquery.default)('[data-sweepbright-list]').animate({
                scrollTop: 0
              }, 200);
            }
          }
        },
        storeMarkers: function storeMarkers(response) {
          if (response.data.estates && response.data.estates.length > 0) {
          ...
          var event = new Event('loadedMap');
          window.dispatchEvent(event);
        },
        getEstates: function getEstates(params) {
          var _this2 = this;
        ...
        $sweepBrightPaginate: function $sweepBrightPaginate(page) {
          this.request.page = page;
          window.location.hash = page;
        },
        $sweepBrightReset: function $sweepBrightReset() {
          this.count += 1;
        ...
        $loadEstates: function $loadEstates(params, callback) {
        ...
        $eventListener: function $eventListener() {
          ...
          if (this.countListener === 1) {
            window.addEventListener('hashchange', function () {
              _this3.$loadEstates({
                sort: _this3.request.sort,
                filters: _this3.request.filters
              });
            }, false);
          }
        },
        $sweepBrightInit: function $sweepBrightInit(params, callback) {
          this.$eventListener();
...
},{"axios":"../../node_modules/axios/index.js","jquery":"../../node_modules/jquery/dist/jquery.js","vuejs-paginate":"../../node_modules/vuejs-paginate/dist/index.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","wp-sweepbright-public.js"], null)
//# sourceMappingURL=public/dist/wp-sweepbright-public.js.map