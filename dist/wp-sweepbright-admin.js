...
},{}],"../vue-components/Properties.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $39ec16 = exports.default || module.exports;
      
      if (typeof $39ec16 === 'function') {
        $39ec16 = $39ec16.options;
      }
    
        /* template */
        Object.assign($39ec16, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { staticClass: "text-sm" }, [
    _c(
      ...
      {
        staticClass:
          "px-2 mb-4 bg-white border-b border-gray-400 wp-admin-heading"
      },
      [
        _c(
          "div",
          ...
          [
            _c(
              "router-link",
              {
                staticClass: "inline-block mr-6 text-base font-semibold",
                attrs: { to: { name: "overview" } }
              },
              [
                _c("i", {
                  staticClass:
                    "mr-1 text-gray-500 dashicons dashicons-admin-multisite"
                }),
                _vm._v("\n        SweepBright for WordPress\n      ")
              ]
            ),
            _vm._v(" "),
            _c("ul", { staticClass: "flex space-x-8 text-base" }, [
              _c(
                "li",
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "inline-block py-4 border-b-2 border-transparent",
                      attrs: {
    ...
    _vm._v(" "),
    _c("div", { staticClass: "mr-4" }, [_c("router-view")], 1)
  ])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$39ec16', $39ec16);
          } else {
            api.reload('$39ec16', $39ec16);
          }
        }
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../../node_modules/vuejs-paginate/dist/index.js":[function(require,module,exports) {
var define;
...
},{}],"../vue-components/Overview.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  components: {
    Paginate: _vuejsPaginate.default
  },
  computed: {
    activePage: {
      get: function get() {
  ...
  methods: {
    ...
    generateUid: function generateUid(estates) {
      var _this = this;

      estates.forEach(function (estate) {
        estate.uid = _this.generateUUID();
      });
      return estates;
    },
    ...
    navigate: function navigate() {
      this.filterQuery();
      var paged = this.estates.slice(this.currentPage * this.postsPerPage, this.currentPage * this.postsPerPage + this.postsPerPage);
    ...
    getEstates: function getEstates() {
      ...
      _axios.default.get("/wp-json/v1/sweepbright/list").then(function (response) {
        _this2.estates = _this2.generateUid(response.data.data);
        _this2.estatesFiltered = _this2.generateUid(response.data.data);

        _this2.setTotalPages();
    ...
    getLogs: function getLogs() {
      ...
      _axios.default.get("/wp-json/v1/sweepbright/logs").then(function (response) {
        _this3.logs = response.data;
        _this3.logsLoaded = true;
      });
    },
    clearCache: function clearCache() {
      var _this4 = this;

      _axios.default.get("/wp-json/v1/sweepbright/cache").then(function () {
        _this4.getEstates();

        _this4.cacheNotification = true;
      });
    },
...
exports.default = _default;
        var $c2f6b8 = exports.default || module.exports;
      
      if (typeof $c2f6b8 === 'function') {
        $c2f6b8 = $c2f6b8.options;
      }
    
        /* template */
        Object.assign($c2f6b8, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _vm.refreshNotification
      ? _c(
          "div",
          { staticClass: "mx-0 mb-4 notice notice-success is-dismissible" },
          [
            _c("p", [_vm._v("Properties refreshed successfully.")]),
            _vm._v(" "),
            _c("button", {
      ...
      : _vm._e(),
    _vm._v(" "),
    _vm.cacheNotification
      ? _c(
          "div",
          { staticClass: "mx-0 mb-4 notice notice-success is-dismissible" },
          [
            _c("p", [_vm._v("Cache has been cleared successfully.")]),
            _vm._v(" "),
            _c("button", {
              staticClass: "notice-dismiss",
              attrs: { type: "button" },
      ...
      : _vm._e(),
    _vm._v(" "),
    _c("div", { staticClass: "flex mb-8 space-x-5" }, [
      _c("div", { staticClass: "flex-1 p-5 bg-white rounded shadow-sm" }, [
        _vm._m(0),
        _vm._v(" "),
        !_vm.logsLoaded
          ...
          : _vm.logs.SYNCHRONIZATION
          ? _c("p", { staticClass: "text-2xl font-light" }, [
              _vm._v("\n        Up to date\n      ")
            ])
          : !_vm.logs.SYNCHRONIZATION && _vm.logsLoaded && _vm.logs.TOTAL > 0
          ? _c("div", { staticClass: "pt-2 text-2xl font-light" }, [
              _c("i", { staticClass: "fal fa-sync fa-spin" }),
              _vm._v(" "),
              _c("span", { staticClass: "ml-2" }, [_vm._v("Updating...")])
            ])
          : _c("div", { staticClass: "pt-2 text-2xl font-light" }, [
              _vm._v("-")
            ])
      ...
      _c("div", { staticClass: "flex-1 p-5 bg-white rounded shadow-sm" }, [
        ...
        _vm._v(" "),
        _c("p", { staticClass: "text-2xl font-light" }, [
          _vm._v(_vm._s(_vm.estatesFiltered.length))
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "flex-1 p-5 bg-white rounded shadow-sm" }, [
        _vm._m(2),
        _vm._v(" "),
        _vm.logsLoaded && _vm.logs.TOTAL > 0
          ? _c("p", { staticClass: "text-2xl font-light" }, [
              _vm._v(
                "\n        " +
                  _vm._s(
                    _vm._f("moment")(_vm.logs.LAST_UPDATED, "from", "now")
                  ) +
                  "\n      "
              )
            ])
    ...
    _c("div", { staticClass: "flex items-center mb-4" }, [
      _c("p", { staticClass: "mr-3 text-3xl font-light" }, [
        _vm._v("Properties")
      ]),
      _vm._v(" "),
      _c(
        ...
        [
          _c("i", { staticClass: "mt-1 dashicons dashicons-update" }),
          _vm._v("\n      Refresh list\n    ")
        ]
      ),
      _vm._v(" "),
      _c(
        ...
        [
          _c("i", { staticClass: "mt-1 dashicons dashicons-trash" }),
          _vm._v("\n      Clear cache\n    ")
        ]
      )
    ]),
    ...
    _c(
      "table",
      {
        staticClass: "mb-4 wp-list-table widefat striped table-view-list pages"
      },
      [
        _vm._m(3),
        _vm._v(" "),
        _c(
          ...
          _vm._l(_vm.estates, function(estate) {
            return _c("tr", { key: estate.uid }, [
              _c(
                "td",
                {
                  staticClass: "flex items-center",
                  attrs: { "data-colname": "Property" }
                },
                [
                  _c(
                    "a",
                        ...
                        [
                          _c("img", {
                            ...
                            attrs: {
                              ...
                              height: "50",
                              src:
                                estate.meta.features.images[0].sizes.thumbnail
                            }
                          })
                        ]
                      )
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "router-link",
                        {
                          staticClass: "font-semibold text-blue-500",
                          attrs: {
                            to: { name: "edit", params: { id: estate.id } }
                          }
                        },
                        [_vm._v(_vm._s(estate.meta.estate.title[_vm.language]))]
                      ),
                      _vm._v(" "),
                      _c("p", [
                        _vm._v(
                          "\n              " +
                            _vm._s(estate.meta.location.street) +
                            "\n              " +
                            _vm._s(estate.meta.location.number) +
                            ",\n              " +
                            _vm._s(estate.meta.location.city) +
                            "\n            "
                        )
                      ])
                    ],
              ...
              _c(
                ...
                [
                  estate.meta.estate.is_project
                    ? [
                        estate.meta.estate.properties
                          ? [
                              _vm._v(
                                "\n              " +
                                  _vm._s(estate.meta.estate.properties.length) +
                                  "\n            "
                              )
                            ]
                          : [_vm._v(" 0 ")]
              ...
              _c(
                ...
                [
                  _vm._v(
                    "\n          " +
                      _vm._s(estate.meta.estate.status) +
                      "\n        "
                  )
                ]
              )
          ...
          [
            _c("paginate", {
              attrs: {
                ...
                "active-class":
                  "font-medium bg-gray-300 py-1 px-2 rounded text-white border border-gray-500",
                "prev-text": "&larr; Back",
                "next-text": "Next &rarr;",
                "hide-prev-next": true
              },
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "mb-2 text-sm font-medium tracking-wider text-gray-600 uppercase"
      },
      [
        _c("i", { staticClass: "dashicons dashicons-update" }),
  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("i", { staticClass: "dashicons dashicons-building" }),
        _vm._v(" Total properties\n      ")
      ]
    )
  },
  function() {
    ...
    return _c(
      ...
      [
        _c("i", { staticClass: "dashicons dashicons-clock" }),
        _vm._v(" Last updated\n      ")
      ]
    )
  },
    ...
    return _c("thead", [
      _c("tr", [
        _c(
          "th",
          {
            staticClass: "manage-column column-title column-primary",
            attrs: { scope: "col" }
          },
          [_vm._v("\n          Property\n        ")]
        ),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c2f6b8', $c2f6b8);
          } else {
            api.reload('$c2f6b8', $c2f6b8);
          }
        }
...
},{"jquery":"../../node_modules/jquery/dist/jquery.js","axios":"../../node_modules/axios/index.js","vuejs-paginate":"../../node_modules/vuejs-paginate/dist/index.js","_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js"}],"../vue-components/Edit.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    addUSP: function addUSP() {
      this.form.usp.push({
        value: ""
      });
    },
    removeUSP: function removeUSP(index) {
    ...
    fillForm: function fillForm() {
      ...
      if (this.estate.meta.custom_fields) {
        ...
        if (this.estate.meta.custom_fields.usp) {
          this.estate.meta.custom_fields.usp.forEach(function (usp) {
            _this.form.usp.push({
              value: usp.usp_item
            });
          });
    ...
    getEstate: function getEstate() {
      ...
      _axios.default.get("/wp-json/v1/sweepbright/property/".concat(this.$route.params.id)).then(function (response) {
        var _response$data = _slicedToArray(response.data, 1),
            estate = _response$data[0];
    ...
    saveChanges: function saveChanges() {
      ...
      _axios.default.post("/wp-json/v1/sweepbright/property/".concat(this.$route.params.id, "/save"), {
        form: this.form
      }).then(function () {
        _this3.saveNotification = true;
      });
    }
  },
  mounted: function mounted() {
...
exports.default = _default;
        var $b2281b = exports.default || module.exports;
      
      if (typeof $b2281b === 'function') {
        $b2281b = $b2281b.options;
      }
    
        /* template */
        Object.assign($b2281b, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      ? _c("div", { staticClass: "wrap" }, [
          _vm.saveNotification
            ? _c(
                ...
                [
                  _c("p", [_vm._v("Changes saved successfully.")]),
                  _vm._v(" "),
                  _c("button", {
                    staticClass: "notice-dismiss",
                    attrs: { type: "button" },
          ...
          _c("div", { staticClass: "flex items-center" }, [
            _c("img", {
              staticClass: "mr-8 border-none",
              attrs: {
                width: "100",
                height: "100",
                src: _vm.estate.meta.features.images[0].sizes.thumbnail
              }
            }),
            _vm._v(" "),
            _c("div", [
              _c("h1", [
                _vm._v(_vm._s(_vm.estate.meta.estate.title[_vm.language]))
              ]),
              _vm._v(" "),
              _c("p", { staticClass: "mb-3 font-semibold" }, [
                _vm._v(
                  "\n          " +
                    _vm._s(_vm.estate.meta.location.street) +
                    "\n          " +
                    _vm._s(_vm.estate.meta.location.number) +
                    ",\n          " +
                    _vm._s(_vm.estate.meta.location.city) +
                    "\n        "
                )
              ]),
              _vm._v(" "),
              _c(
                ...
                {
                  staticClass: "button action",
                  attrs: { href: _vm.estate.permalink, target: "_blank" }
                },
                ...
                _c("tr", [
                  ...
                  _c("td", [
                    ...
                    _c("input", {
                      ...
                      attrs: { type: "text", id: "phase" },
                      domProps: { value: _vm.form.phase },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.form, "phase", $event.target.value)
                        }
                      }
                    })
                  ])
                ...
                _c("tr", [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("br"),
                      _vm._v(" "),
                      _vm._l(_vm.form.usp, function(usp, index) {
                        return _c("div", { key: index, staticClass: "mb-2" }, [
                            ...
                            directives: [
                              {
                                ...
                                rawName: "v-model",
                                value: usp.value,
                                expression: "usp.value"
                              }
                            ],
                            staticClass: "regular-text",
                            attrs: { type: "text" },
                            domProps: { value: usp.value },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                                }
                                _vm.$set(usp, "value", $event.target.value)
                              }
                            }
                          }),
                          _vm._v(" "),
                          _c(
                            "button",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.removeUSP(index)
                                }
                              }
                            },
                            [
                              _c("i", {
                                staticClass: "mt-1 dashicons dashicons-trash"
                              })
                            ]
                          )
                        ])
                      ...
                      _c("div", { staticClass: "mt-2" }, [
                        _c(
                          ...
                          [
                            _c("i", {
                              staticClass: "mt-1 dashicons dashicons-plus-alt2"
                            }),
                            _vm._v(
                              "\n                Add selling point\n              "
                            )
...
var staticRenderFns = [
  function() {
    ...
    return _c("th", { attrs: { scope: "row" } }, [
      _c("label", { attrs: { for: "phase" } }, [_vm._v("Construction phase")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("th", { attrs: { scope: "row" } }, [
      _c("label", [_vm._v("Unique selling points")])
    ])
  }
]
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b2281b', $b2281b);
          } else {
            api.reload('$b2281b', $b2281b);
          }
        }
...
},{"axios":"../../node_modules/axios/index.js","_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js"}],"../../node_modules/vue-moment/dist/vue-moment.js":[function(require,module,exports) {
var define;
var global = arguments[3];
(function (global, factory) {
...
},{}],"wp-sweepbright-admin.js":[function(require,module,exports) {
"use strict";
...
var _Properties = _interopRequireDefault(require("../vue-components/Properties.vue"));

var _Overview = _interopRequireDefault(require("../vue-components/Overview.vue"));

var _Edit = _interopRequireDefault(require("../vue-components/Edit.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Pages
_vue.default.use(require('vue-moment')); // Devtools


_vue.default.config.productionTip = false;
_vue.default.config.devtools = false; // Router
...
(0, _jquery.default)(document).ready(function () {
  if (document.querySelector('#sweepbright-properties')) {
    new _vue.default({
      ...
      render: function render(h) {
        return h(_Properties.default);
      }
    });
  }
});
},{"vue":"../../node_modules/vue/dist/vue.runtime.esm.js","vue-router":"../../node_modules/vue-router/dist/vue-router.esm.js","jquery":"../../node_modules/jquery/dist/jquery.js","../css/style.css":"../css/style.css","../vue-components/Properties.vue":"../vue-components/Properties.vue","../vue-components/Overview.vue":"../vue-components/Overview.vue","../vue-components/Edit.vue":"../vue-components/Edit.vue","vue-moment":"../../node_modules/vue-moment/dist/vue-moment.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","wp-sweepbright-admin.js"], null)
//# sourceMappingURL=admin/dist/wp-sweepbright-admin.js.map