	...
	public static function retrieve()
	{
		return [
			...
			'sub_fields' => [
				...
				[
					'key'    => 'ongoing_litigation',
					'label'  => 'Ongoing litigation',
					'name'   => 'ongoing_litigation',
					'type' => 'select',
					'default_value' => null,
					'readonly' => 0,
					'disabled' => 0,
				...
				[
					'key'    => 'renovation_obligation',
					'label'  => 'Renovation obligation',
				...
				[
					'key'    => 'asbestos_certificate',
					'label'  => 'Asbestos certificate',
					'name'   => 'asbestos_certificate',
					'type' => 'select',
					'default_value' => null,
					'readonly' => 0,
					'disabled' => 0,
				...
				[
					'key'    => 'asbestos_certificate_reference',
					'label'  => 'Asbestos certificate reference',
					'name'   => 'asbestos_certificate_reference',
					'type'   => 'text',
				],
			],
		];
