...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/favorites.js":[function(require,module,exports) {
"use strict";
...
var favorites = function favorites() {
  if (document.querySelector("[data-favorites]")) {
    window.addEventListener("favorite", function (args) {
...
},{"process":"../node_modules/process/browser.js"}],"src/scroll.js":[function(require,module,exports) {
"use strict";
...
var scroll = function scroll() {
  if (document.querySelector(".js-navigation")) {
    ...
    var id = document.querySelector(".js-navigation").dataset.component;
    var component = window[id]; // Fixed navigation

    var init = 0;

    var fixBanner = function fixBanner() {
    ...
    var unfixBanner = function unfixBanner() {
      if (document.querySelector("[data-banner]")) {
    ...
    var showSmallLogo = function showSmallLogo() {
    ...
    var showLargeLogo = function showLargeLogo(isMidScroll) {
    ...
    var showEstateMenu = function showEstateMenu() {
    ...
    var hideEstateMenu = function hideEstateMenu() {
      if (component.estate_id) {
    ...
    var detachMenu = function detachMenu() {
    ...
    var attachMenu = function attachMenu(isMidScroll) {
    ...
    if (document.querySelector(".js-navigation")) {
      ...
      var fixedScroll = function fixedScroll() {
      ...
      (0, _jquery.default)(document).on("resize", function () {
        fixedScroll();
      });
    }
  }
...
var _default = scroll;
exports.default = _default;
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/vue/dist/vue.common.dev.js":[function(require,module,exports) {
var global = arguments[3];
/*!
 * Vue.js v2.6.14
...
exports.default = _default;
        var $71b3e5 = exports.default || module.exports;
      
      if (typeof $71b3e5 === 'function') {
        $71b3e5 = $71b3e5.options;
      }
    
        /* template */
        Object.assign($71b3e5, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass:
            "fixed top-0 flex w-full py-3 bg-white shadow z-60 lg:hidden js-navigation-mobile",
          attrs: { role: "navigation" }
        },
        [
          _c("div", { staticClass: "flex items-center flex-1 ml-4" }, [
            _c(
              "a",
              {
                staticClass: "inline-block w-48 outline-none",
                attrs: { href: "/" }
              },
              [_c("img", { attrs: { src: _vm.data.large_logo } })]
            )
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "flex items-center mx-4 space-x-3" }, [
            _vm.data.favorites.enabled
              ? _c(
                  "a",
                  {
                    staticClass: "relative inline-block px-3",
                    attrs: { href: _vm.data.favorites.link }
                  },
                  [
                    _vm.totalFavorites > 0
                      ? _c(
                          "div",
                          {
                            staticClass:
                              "absolute right-0 flex items-center justify-center w-5 h-5 -mt-1 text-sm font-medium text-white bg-red-500 rounded-full "
                          },
                          [
                            _c("span", [
                              _vm._v(
                                "\n            " +
                                  _vm._s(_vm.totalFavorites) +
                                  "\n          "
                              )
                            ])
                          ]
                    ...
                    _vm._v(" "),
                    _c("i", {
                      staticClass: "text-2xl fa-heart",
                      class: _vm.totalFavorites > 0 ? "fas" : "fal"
                    })
                  ]
                )
              : _vm._e(),
            ...
            _c(
              ...
              {
                staticClass:
                  "flex items-center justify-center w-10 text-xl outline-none btn btn-primary",
        ...
        [
          _vm.menuOpen
            ? _c(
                ...
                {
                  staticClass:
                    "fixed top-0 z-50 w-full h-screen pt-24 overflow-hidden bg-primary lg:hidden"
                },
                [
                  _c("div", { staticClass: "p-10" }, [
                    _c(
                      "ul",
                      { staticClass: "space-y-8 text-3xl font-normal" },
                      [
                        ...
                        _vm._v(" "),
                        _vm.data.call_to_action.label &&
                        _vm.data.call_to_action.link
                          ? _c("li", [
                              _c(
                                "a",
                                {
                                  staticClass:
                                    "block w-full text-center outline-none btn btn-default",
                                  attrs: { href: _vm.data.call_to_action.link }
                                },
                                [_vm._v(_vm._s(_vm.data.call_to_action.label))]
                              )
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                        _vm.data.multilanguage.enabled
                          ? _c("li", [
                              _c(
                                "div",
                                {
                                  staticClass:
                                    "relative block pt-10 text-white border-t border-white border-opacity-25 group"
                                },
                                [
                                  _c(
                                    "p",
                                    {
                                      staticClass:
                                        "mb-3 text-base font-semibold tracking-wide uppercase opacity-60"
                                    },
                                    [
                                      _vm.data.multilanguage.current_lang ===
                                      "nl"
                                        ? [_vm._v("Kies uw taal")]
                                        : _vm._e(),
                                      _vm._v(" "),
                                      _vm.data.multilanguage.current_lang ===
                                      "fr"
                                        ? [_vm._v("Choisissez votre langue")]
                                        : _vm._e(),
                                      _vm._v(" "),
                                      _vm.data.multilanguage.current_lang ===
                                      "en"
                                        ? [_vm._v("Choose your language")]
                                        : _vm._e()
                                    ],
                                    2
                                  ),
                                  ...
                                  _c(
                                    ...
                                    {
                                      staticClass:
                                        "absolute hidden w-auto py-2 text-base font-semibold tracking-wide uppercase bg-white rounded shadow group-hover:block text-dark"
                                    },
                                    [
                                      _vm.data.multilanguage.enabled_nl
                                        ? _c("li", [
                                            _c(
                                              "a",
                                              {
                                                staticClass:
                                                  "block px-5 py-2 transition duration-200 hover:bg-gray-100",
                                                attrs: { href: "?lang=nl" }
                                              },
                                              [
                                                _vm._v(
                                        ...
                                        : _vm._e(),
                                      _vm._v(" "),
                                      _vm.data.multilanguage.enabled_fr
                                        ? _c("li", [
                                            _c(
                                              "a",
                                              {
                                        ...
                                        : _vm._e(),
                                      _vm._v(" "),
                                      _vm.data.multilanguage.enabled_en
                                        ? _c("li", [
                                            _c(
                                              "a",
                                              {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$71b3e5', $71b3e5);
          } else {
            api.reload('$71b3e5', $71b3e5);
          }
        }
...
},{"vue-hot-reload-api":"../../../../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"src/navigation.js":[function(require,module,exports) {
"use strict";
...
var _Navigation = _interopRequireDefault(require("../components/Navigation.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var navigation = function navigation() {
  (0, _jquery.default)(".navigation-default").each(function (index, el) {
    _vue.default.config.productionTip = false;
    _vue.default.config.devtools = false;
    new _vue.default({
      el: ".".concat(el.className),
      render: function render(h) {
        return h(_Navigation.default, {
          props: {
...
exports.default = _default;
},{"jquery":"../node_modules/jquery/dist/jquery.js","vue":"../node_modules/vue/dist/vue.common.js","../components/Navigation.vue":"components/Navigation.vue"}],"main.js":[function(require,module,exports) {
"use strict";

require("./main.css");

var _favorites = _interopRequireDefault(require("./src/favorites.js"));

var _scroll = _interopRequireDefault(require("./src/scroll.js"));

var _navigation = _interopRequireDefault(require("./src/navigation.js"));
...
},{"./main.css":"main.css","./src/favorites.js":"src/favorites.js","./src/scroll.js":"src/scroll.js","./src/navigation.js":"src/navigation.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
