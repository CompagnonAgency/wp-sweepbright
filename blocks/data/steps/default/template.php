...
<?php if (WP_Wrapper::get('steps', $component, $args)) : ?>
  <div class="glide steps-default" data-component="component_<?= str_replace('-', '_', $args['column']['id']); ?>">
    <div class="flex justify-end mb-8 space-x-16 glide__arrows <?= WP_Wrapper::get('arrow_color', $component, $args); ?>" data-glide-el="controls">
        ...
        <?php foreach (WP_Wrapper::get('steps', $component, $args) as $index => $step) : ?>
          <li class="glide__slide">
            <div class="relative h-full pt-8 lg:pl-8">
              <div class="absolute top-0 left-0 flex items-center justify-center w-16 h-16 text-2xl font-medium <?= WP_Wrapper::get('background_color', $component, $args); ?> border-2 rounded-full border-primary">
                <?= sprintf('%02d', $index + 1); ?>
              </div>
